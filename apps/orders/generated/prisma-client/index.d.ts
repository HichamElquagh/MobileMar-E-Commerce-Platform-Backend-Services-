...
export namespace Prisma {
  ...
  */
   ...
   * UserCountOutputType without action
   */
  export type UserCountOutputTypeCountCommandesArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
   ...
   * ProduitCountOutputType without action
   */
  export type ProduitCountOutputTypeCountCommandesArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    where?: OrderitemWhereInput;
  };
   ...
   * OrderitemCountOutputType without action
   */
  export type OrderitemCountOutputTypeCountOrderArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
  ...
  > extends Prisma.PrismaPromise<T> {
    ...
    commandes<T extends User$commandesArgs<ExtArgs> = {}>(
      args?: Subset<T, User$commandesArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<
   ...
   * User.commandes
   */
  export type User$commandesArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
  ...
  > = {
     ...
     */
    orderBy?:
      | ProduitOrderByWithRelationInput
      | ProduitOrderByWithRelationInput[];
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     *
  ...
  > = {
    where?: ProduitWhereInput;
    orderBy?:
      | ProduitOrderByWithAggregationInput
      | ProduitOrderByWithAggregationInput[];
  ...
  type GetProduitGroupByPayload<T extends ProduitGroupByArgs> =
    Prisma.PrismaPromise<
      Array<
  ...
  type ProduitGetPayload<
    S extends boolean | null | undefined | ProduitDefaultArgs,
  > = $Result.GetResult<Prisma.$ProduitPayload, S>;

  type ProduitCountArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  ...
  > {
    ...
    findFirst<T extends ProduitFindFirstArgs<ExtArgs>>(
      ...
      $Result.GetResult<Prisma.$ProduitPayload<ExtArgs>, T, 'findFirst'> | null,
      null,
      ExtArgs
    >;
    ...
    findFirstOrThrow<T extends ProduitFindFirstOrThrowArgs<ExtArgs>>(
      ...
      $Result.GetResult<Prisma.$ProduitPayload<ExtArgs>, T, 'findFirstOrThrow'>,
      never,
      ExtArgs
    >;
    ...
    findMany<T extends ProduitFindManyArgs<ExtArgs>>(
      ...
      $Result.GetResult<Prisma.$ProduitPayload<ExtArgs>, T, 'findMany'>
    >;
    ...
    create<T extends ProduitCreateArgs<ExtArgs>>(
      ...
      $Result.GetResult<Prisma.$ProduitPayload<ExtArgs>, T, 'create'>,
      never,
      ExtArgs
    >;
    ...
    delete<T extends ProduitDeleteArgs<ExtArgs>>(
      ...
      $Result.GetResult<Prisma.$ProduitPayload<ExtArgs>, T, 'delete'>,
      never,
      ExtArgs
    >;
    ...
    update<T extends ProduitUpdateArgs<ExtArgs>>(
      ...
      $Result.GetResult<Prisma.$ProduitPayload<ExtArgs>, T, 'update'>,
      never,
      ExtArgs
    >;
    ...
    upsert<T extends ProduitUpsertArgs<ExtArgs>>(
      ...
      $Result.GetResult<Prisma.$ProduitPayload<ExtArgs>, T, 'upsert'>,
      never,
      ExtArgs
    >;
    ...
    aggregate<T extends ProduitAggregateArgs>(
      args: Subset<T, ProduitAggregateArgs>,
    ...
    >(
      args: SubsetIntersection<T, ProduitGroupByArgs, OrderByArg> & InputErrors,
    ): {} extends InputErrors
  ...
  > extends Prisma.PrismaPromise<T> {
    ...
    commandes<T extends Produit$commandesArgs<ExtArgs> = {}>(
      args?: Subset<T, Produit$commandesArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<
      $Result.GetResult<Prisma.$OrderitemPayload<ExtArgs>, T, 'findMany'> | Null
    >;
   ...
   * Produit.commandes
   */
  export type Produit$commandesArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the Orderitem
  ...
  > extends Prisma.PrismaPromise<T> {
    ...
    produit<T extends ProduitDefaultArgs<ExtArgs> = {}>(
      args?: Subset<T, ProduitDefaultArgs<ExtArgs>>,
    ): Prisma__ProduitClient<
      | $Result.GetResult<
          Prisma.$ProduitPayload<ExtArgs>,
          T,
  ...
  export type ProduitScalarWhereWithAggregatesInput = {
    AND?:
      | ProduitScalarWhereWithAggregatesInput
      | ProduitScalarWhereWithAggregatesInput[];
  ...
  export type OrderitemCreateNestedManyWithoutUserInput = {
    create?:
      | XOR<
          ...
          OrderitemUncheckedCreateWithoutUserInput
        >
      | OrderitemCreateWithoutUserInput[]
      | OrderitemUncheckedCreateWithoutUserInput[];
    connectOrCreate?:
  ...
  export type OrderitemCreateNestedManyWithoutProduitInput = {
    create?:
      | XOR<
          OrderitemCreateWithoutProduitInput,
          OrderitemUncheckedCreateWithoutProduitInput
        >
      | OrderitemCreateWithoutProduitInput[]
      | OrderitemUncheckedCreateWithoutProduitInput[];
    connectOrCreate?:
      | OrderitemCreateOrConnectWithoutProduitInput
      | OrderitemCreateOrConnectWithoutProduitInput[];
  ...
  export type OrderitemUpdateManyWithoutProduitNestedInput = {
    ...
    connectOrCreate?:
      ...
      | OrderitemCreateOrConnectWithoutProduitInput[];
    upsert?:
      | OrderitemUpsertWithWhereUniqueWithoutProduitInput
      | OrderitemUpsertWithWhereUniqueWithoutProduitInput[];
    createMany?: OrderitemCreateManyProduitInputEnvelope;
    set?: OrderitemWhereUniqueInput | OrderitemWhereUniqueInput[];
    disconnect?: OrderitemWhereUniqueInput | OrderitemWhereUniqueInput[];
    ...
    connect?: OrderitemWhereUniqueInput | OrderitemWhereUniqueInput[];
    update?:
      | OrderitemUpdateWithWhereUniqueWithoutProduitInput
      | OrderitemUpdateWithWhereUniqueWithoutProduitInput[];
    updateMany?:
      | OrderitemUpdateManyWithWhereWithoutProduitInput
      | OrderitemUpdateManyWithWhereWithoutProduitInput[];
    deleteMany?: OrderitemScalarWhereInput | OrderitemScalarWhereInput[];
  };
  ...
  export type UserCreateNestedOneWithoutCommandesInput = {
    create?: XOR<
      UserCreateWithoutCommandesInput,
      UserUncheckedCreateWithoutCommandesInput
    >;
  ...
  export type ProduitCreateNestedOneWithoutCommandesInput = {
    create?: XOR<
      ProduitCreateWithoutCommandesInput,
      ProduitUncheckedCreateWithoutCommandesInput
    >;
  ...
  export type UserUpdateOneRequiredWithoutCommandesNestedInput = {
    ...
    update?: XOR<
      XOR<
        UserUpdateToOneWithWhereWithoutCommandesInput,
        UserUpdateWithoutCommandesInput
      >,
      UserUncheckedUpdateWithoutCommandesInput
    >;
  };
  ...
  export type ProduitUpdateOneRequiredWithoutCommandesNestedInput = {
    ...
    update?: XOR<
      XOR<
        ProduitUpdateToOneWithWhereWithoutCommandesInput,
        ProduitUpdateWithoutCommandesInput
      >,
      ProduitUncheckedUpdateWithoutCommandesInput
    >;
  };
  ...
  export type OrderitemUpdateOneRequiredWithoutOrderNestedInput = {
    ...
    update?: XOR<
      XOR<
        OrderitemUpdateToOneWithWhereWithoutOrderInput,
  ...
  export type OrderitemUpsertWithWhereUniqueWithoutUserInput = {
    ...
    update: XOR<
      ...
      OrderitemUncheckedUpdateWithoutUserInput
    >;
    create: XOR<
      OrderitemCreateWithoutUserInput,
      OrderitemUncheckedCreateWithoutUserInput
  ...
  export type OrderitemUpdateManyWithWhereWithoutUserInput = {
    ...
    data: XOR<
      OrderitemUpdateManyMutationInput,
      OrderitemUncheckedUpdateManyWithoutUserInput
    >;
  };
  ...
  export type OrderitemUpsertWithWhereUniqueWithoutProduitInput = {
    where: OrderitemWhereUniqueInput;
    update: XOR<
      OrderitemUpdateWithoutProduitInput,
      OrderitemUncheckedUpdateWithoutProduitInput
    >;
    create: XOR<
      OrderitemCreateWithoutProduitInput,
      OrderitemUncheckedCreateWithoutProduitInput
  ...
  export type OrderitemUpdateManyWithWhereWithoutProduitInput = {
    ...
    data: XOR<
      OrderitemUpdateManyMutationInput,
      OrderitemUncheckedUpdateManyWithoutProduitInput
    >;
  };
  ...
  export type ProduitCountOutputTypeArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = ProduitCountOutputTypeDefaultArgs<ExtArgs>;
  /**
